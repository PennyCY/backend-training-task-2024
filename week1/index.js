...
const weightTrainingOneToOnePrice = 1500;
const exerciseBudget = 3000;
...
let AlexBudget = exerciseBudget - 3*yogaGroupPrice -weightTrainingGroupPrice- weightTrainingOneToOnePrice;
...
myWater +=1000;//下午健身前裝了1000cc
myWater -=700;//健身喝700cc
...
//宣告變數numberArr1,並賦予值為陣列5,10,15;
let numberArr2 = numberArr1;
//宣告變數numberArr2,並賦予值為陣列numberArr1;
numberArr2.push(20);
//在陣列numberArr2加入新值20;
numberArr2 = [25, 30, 35];
